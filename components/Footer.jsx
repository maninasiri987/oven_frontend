          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex items-center justify-start gap-3">
                ...
                <a href="https://t.me/ovenweb" target="_blank" rel="noopener noreferrer" className="social-tg w-10 h-10 flex items-center justify-center rounded-full bg-dusty-grape/40 transition-all duration-200 cursor-pointer">
