...
const faqs = [
  { q: 'چقدر زمان می‌برد؟', a: 'بسته به پلن انتخابی: پلن‌های اقتصادی بین ۷ تا ۱۰ روز، پلن‌های حرفه‌ای ۲ تا ۴ هفته و پلن‌های اختصاصی ۲ تا ۳ ماه زمان می‌برند.' },
  { q: 'هزینه‌ها چطور محاسبه می‌شود؟', a: 'هزینه بر اساس پلن انتخابی و نوع پروژه (فروشگاهی یا شرکتی) محاسبه می‌شود. با استفاده از ابزار برآورد اولیه می‌توانید هزینه تقریبی را ببینید.' },
  { q: 'آیا دامنه رایگان شامل می‌شود؟', a: 'بله، همه پلن‌ها شامل یک دامنه .ir رایگان به مدت یک سال و گواهی SSL رایگان هستند.' },
